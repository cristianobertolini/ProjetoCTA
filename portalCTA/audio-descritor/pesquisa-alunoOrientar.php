...
?>
    ...
    <div class="band">
        <div class="container">
            <h2 class="primary stroked-bottom text-shadowed margin-bottom "> Pesquisa de alunos orientados</h2>
            <!--Formulário de busca-->
            <form id="busca-usuario" action="pesquisa-alunoOrientar-busca.php" method="post">            
                <div class="row"> 
                    <div class="span2"> 
                    ...
                    <div class="span3"> 
                        ...
                        <br >
                        <select id="periodo" name="semestre" class="selectfield">
