<?php   
    ...
    if (mysqli_num_rows($resposta) > 0){
        ...
        echo "<script>location.href='../esqueciSenha.php?mensagem1=Operação realizada com sucesso!<br>A nova senha foi enviada para o seguinte endere�o: $email <br>A entrega do e-mail com a nova senha pode demorar alguns minutos. Caso n�o o encontre, verifique a caixa de Spam.';</script>";
    } else {        
