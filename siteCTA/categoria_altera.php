    ...
    ?>
        ...
        <div class="w3-container w3-section w3-padding-large w3-card-4 w3-light-grey">
            ...
            <div class="w3-container">
                <form id="consulta" action="categoria_busca.php" method="POST">
                    <div class="w3-section">
                        <div class="w3-row">
                            <label for="consulta"><strong>Nome</strong></label>
                            <div class="w3-col s8">
                                <input class="w3-input w3-border w3-margin-bottom"  name="nome" id="nome" type="text" maxlength="50" placeholder="Insira o nome da categoria que deseja Buscar" required >
                            </div>
                            <div class="w3-col s1">
                                &nbsp;
                            </div>
